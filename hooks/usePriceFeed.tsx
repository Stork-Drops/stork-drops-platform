...
//       return result;
//     },
//     { refetchInterval: false, enabled: (mints?.length ?? 0) > 0 }
//   );
// }
...
const usePriceFeed = (mints: [string]) => {
  const { data, error, isValidating } = useSWR(
    `https://api.coingecko.com/api/v3/simple/token_price/solana?include_24hr_change=true&vs_currencies=usd&contract_addresses=`,
    fetcher,
