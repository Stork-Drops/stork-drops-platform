...
const Profile = () => {
  ...
  const portfolioItemTotal = (tokenCollection.length + 1) + nfts.length + domainCollection.length;
                                                        ...
                                                        <Row align="center">
                                                          ...
                                                          <Col>
                                                            <p className="text-sm font-semibold">
                                                              <TokenName mint="So11111111111111111111111111111111111111112"/>
                                                            </p>
                                                    ...
                                                    {tokenCollection && tokenCollection.length > 0 ? (
                                                      ...
                                                      <Grid xs={12}>
                                                        ...
                                                        <Row align="center">
                                                          ...
                                                          <Col>
                                                            <span className="font-semibold text-sm">
                                                              $<TokenTotalPrice tokenAddress={(account.account.data["parsed"]["info"]["mint"])} sumAmount={(account.account.data["parsed"]["info"]["tokenAmount"]["uiAmount"])}/>
                                                            </span>
                                                            <div className="text-dracula font-semibold text-sm">
